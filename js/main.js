let link = document.querySelector(".modal-btn");
let popup = document.querySelector(".modal-login");
let close = document.querySelector(".modal-close");

let form = popup.querySelector("form");
let login = popup.querySelector(".user-name");
let email = popup.querySelector(".user-email");
let message = popup.querySelector("[name=letter]");
